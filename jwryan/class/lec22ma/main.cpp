 ...
 *              associated with lecture 22 on inserting nodes into
 *              linked lists using a function.
 *
 *              For the mini-assignment, you must add code in the indicated
 *              location so that the starting linked list contains nodes with
 *              data member values 2 4 6 8.
 -------------------------------------------------------------------------------*/
#include <stdio.h>
#include <stdlib.h>
#include <iostream>
...
int main( void )
{
    ...
    /* TODO: add mini-assignment code here */
    int i;
    for(i=2; i<=8; i+=2)
    {
        insertNodeInLinkedList(&startPtr, i);
    }
